...
if (isset($_POST['dat-hang'])) {
    ...
    $insertOrder = mysqli_query($conn, "INSERT INTO `order_pro` (user_id, email, name, sdt, address, province, district, ward, hour, day, methodCheck, total, note)
    VALUES ('$user_id', '$orderEmail', '$orderName', '$orderSDT', '$orderAddress', '$orderProvince', '$orderDistrict', 
    '$orderWard', '$orderHour', '$orderDay', '$orderTT', '$orderTotal', '$orderNote')") or die('query failed');
