...
if (isset($_POST['book-table'])) {
    ...
    mysqli_query($conn, "INSERT INTO `booking` (user_id, name, sdt, email, person, hour, day, note) 
        VALUE ('$user_id', '$bookName', '$bookSdt', '$bookEmail', '$bookPerson', '$bookTime', '$bookDate', '$bookNote')") or die('query failed');
                                ...
                                <div class="col-lg-5">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="book-title">
                                            ...
                                            <p>Nơi gửi yêu cầu đặt bàn trước và chúng tôi sẽ chuẩn bị cho bạn</p>
                                        </div>
                                        <div class="book-user">
                                        ...
                                        <div class="book-note">
                                            ...
                                            <input type="submit" name="book-table" value="Book A Table">
                                        </div>
                                    </form>
